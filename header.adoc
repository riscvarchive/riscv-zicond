[[header]]
:description: RISC-V Integer Conditional Operations (ZiCondOps) extension
:company: RISC-V.org
:revdate: 9/2022
:revnumber: 1.0
...
= RISC-V Integer Conditional Operations (ZiCondOps) extension
