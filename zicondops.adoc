...
[#insns-czero-eqz,reftext="Mask register value, if condition is not-equal to zero"]
=== czero.eqz
...
[#insns-czero-nez,reftext="Mask register value, if condition is equal to zero"]
=== czero.nez
